...
class GetPeopleWithSpecialNeedsUseCase {
  late HomeReposatory _homeReposatory;

  GetPeopleWithSpecialNeedsUseCase(this._homeReposatory);

  Future<Either<Failure, List<ProductsDataModel>>> call() async {
    return await _homeReposatory.getPeopleWithSpecialNeedsProducts();
  }
}
